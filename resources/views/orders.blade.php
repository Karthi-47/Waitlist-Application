...
<body><!-- Start: Navbar Right Links (Dark) -->
  ...
  <div class="container-fluid">
    <h3 class="text-dark mb-4" style="margin-top: 17px;">Pre Booking Details</h3>
          ...
          <div class="row" style="margin-bottom: 25px;text-align: left;">
            <div class="col-md-6 text-start">
              <div class="mb-3"><label class="form-label" for="lastname"><strong>First Name</strong></label><input
                  class="form-control" type="text" id="fname" name="fname" placeholder="Enter First Name" required></div>
            </div>
            <div class="col-md-6 text-start">
              <div class="mb-3"><label class="form-label" for="firstname"><strong>Last Name</strong></label><input
                  class="form-control" type="text" id="lname" name="lname" placeholder="Enter Last Name" required></div>
            </div>
            <div class="col-md-6">
              <div class="mb-3"><label class="form-label" for="email"><strong>Email&nbsp;</strong></label><input
                  class="form-control" type="email" placeholder="Enter Email" id="email" name="email" required></div>
            </div>
            <div class="col-md-6">
              <div class="mb-3"><label class="form-label" for="phone"><strong>Phone Number</strong></label><input
                  class="form-control" type="phone" placeholder="Enter Phone Number" name="phone" id="phone" required></div>
            </div>
            <div class="col-md-6">
              <div class="mb-3"><label class="form-label" for="country"><strong>Country</strong></label><input
                  class="form-control" type="text" placeholder="Enter Country" name="country" id="country" required></div>
            </div>
            <div class="col-md-6">
              <div class="mb-3"><label class="form-label" for="state"><strong>State</strong></label><input
                  class="form-control" type="text" placeholder="Enter State" name="state" id="state" required></div>
            </div>
            <div class="col-md-6">
              <div class="mb-3"><label class="form-label" for="city"><strong>City</strong></label><input
                  class="form-control" type="text" id="city" placeholder="Enter City" name="city" required></div>
            </div>
            <div class="col-md-6">
              <div class="mb-3"><label class="form-label" for="pincode"><strong>Pincode</strong></label><input
                  class="form-control" type="text" placeholder="Enter Pincode" name="pincode" id="pincode" required></div>
            ...
            <div class="col-md-12" style="text-align: right;margin-top: 5px;"><button class="btn btn-primary btn-sm"
                ...
                style="padding: 9px 8px;width: 110.6842px;font-size: 15px;">Book Now</button></div>
          </div>
        </form><!-- End: Form -->
      </div>
    </div>
