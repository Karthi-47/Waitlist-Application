      ...
      <div class="collapse navbar-collapse" id="navcol-5">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item"><a class="nav-link" data-bss-disabled-mobile="true" data-bss-hover-animate="pulse"
              href="index" style="font-family: Poppins, sans-serif;" onclick="location.href='admin';">Back</a></li>
        </ul><a class="btn btn-primary ms-md-2" role="button" data-bss-disabled-mobile="true" data-aos="fade-down"
        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header py-2" style="background: var(--bs-form-valid-border-color);">
              <p class="lead text-info m-0"><strong>Administrator</strong></p>
            </div>
                ...
                <table class="table table-striped table-sm my-0 mydatatable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="text-align: center;"><a href="details/{{$data->id}}/edit" class="btn btn-dark btn-sm"><i class="bi
                        bi-pencil-square"></i></a>
                        <a href="details/{{$data->id}}/delete" onclick="return confirm('Are you sure you want to Delete?')" class="btn btn-danger btn-sm"><i class="bi
                        bi-trash"></i></a></td>
                    </tr>
                    @endforeach
                  </tbody>
